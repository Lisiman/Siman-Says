...
var Simon = {
		...
		copies: [],
		round: 0,
		colorTable: {1: "red", 2: "green", 3: "yellow", 4: "blue"},
		active: true,
		mode: 'normal',
		...
		newRound: function() {
			...
			this.copies = this.sequence.slice(0);
		...
		registerClick: function(e) {
			//console.log(this.copies.shift());
			//console.log("this is E" , e)
			var desiredResponse = this.colorTable[this.copies.shift()];
			console.log("Desired: " + desiredResponse);
			var actualResponse = $(e.target).data('color');
		...
		checkLose: function() {
			...
			if (this.copies.length === 0 && this.active) {
